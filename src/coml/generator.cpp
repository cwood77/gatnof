...
void generator::genHeaders(std::ostream& out)
{
   out << "// *******************************" << std::endl;
...
void generator::genImage(std::ostream& out)
{
   out << std::endl;
   out << "class " << m_ir.name << "_image : public cui::iImage {" << std::endl;
   out << "public:" << std::endl;
...
void generator::genDerivedControlObjects(std::ostream& out)
{
...
{
   out << std::endl;
   out << "class " << m_ir.name << "_screen : public cui::basicScreen {" << std::endl;
   ...
   out << std::endl;
   out << "public:" << std::endl;
   out << "   " << m_ir.name << "_screen()" << std::endl;
   out << "   {" << std::endl;
